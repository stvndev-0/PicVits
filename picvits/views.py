...
def home_view(request):
    ...
    return render(request, 'home.html', {'picts': picts})

def pict_view(request, pict_id):
    pict = Picture.objects.get(id=pict_id)
    return render(request, 'pict_view.html', {'pict': pict})
...
def new_picture_view(request):
    ...
    return render(request, 'crud/picture_form.html', {'picture_form': picture_form})
...
def search_view(request):
    ...
    return render(request, 'search.html', {'searched': searched, 'picts': picts})